...
layout = go.Layout(
    title='กราฟแท่งแสดงยอดผู้เสียชีวิตจากการฆ่าตัวตายในประเทศไทยตั้งแต่ พ.ศ.2548 - 2557',
    xaxis=dict(
        title='จำนวนปีตั้งแต่ พ.ศ.2548 - 2557',
        titlefont=dict(
            size=16,
    ...
    yaxis=dict(
        title='จำนวนคนฆ่าตัวตายต่อประชากรล้านคน',
        titlefont=dict(
            size=16,
            color='rgb(107, 107, 107)'
        ),
